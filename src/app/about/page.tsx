        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
          ...
          <div className="bg-slate-100 rounded-[80px] aspect-square relative overflow-hidden group">
            ...
            <div className="absolute bottom-12 left-12 right-12 bg-white/95 backdrop-blur-md p-10 rounded-[40px] shadow-2xl">
              <p className="text-primary text-xl font-bold leading-tight font-outfit uppercase">"We don't just process applications; we shape your career."</p>
      ...
      <section className="bg-[#022c22] py-32 rounded-[100px] mx-6">
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-16 lg:gap-8">
            {[
              { label: "Admissions", value: "15,000+", icon: <GraduationCap size={40} /> },
              { label: "University Partners", value: "800+", icon: <Briefcase size={40} /> },

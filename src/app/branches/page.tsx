...
export const metadata: Metadata = {
  title: "Eccho Overseas Branch Offices | Study Abroad Consultants Near You | Guntur, Hyderabad, UK",
  description: "Find your nearest Eccho Overseas branch office. Expert study abroad counselors available in Guntur, Vijayawada, Hyderabad, and Canterbury UK. Walk-in consultations, visa guidance, and personalized career planning for international education.",
  keywords: ["Eccho Overseas branches", "study abroad consultants Guntur", "study abroad Hyderabad", "overseas education Vijayawada", "UK education consultants near me"],
  openGraph: {
    title: "Our Branches | Eccho Overseas Global Network",
    description: "Walk into any Eccho Overseas branch for expert study abroad guidance. Offices across India and the UK.",
  },
};
      ...
      <div className="max-w-7xl mx-auto px-6 -mt-10 relative z-20">
        <div className="bg-white rounded-[40px] shadow-2xl shadow-emerald-900/10 p-8 lg:p-12 border border-slate-100 flex flex-col md:flex-row justify-between items-center gap-8">
          <div className="flex items-center gap-6">
            ...
            <div>
              <h4 className="text-xl font-black text-primary uppercase tracking-tight">Head Office</h4>
              <p className="text-slate-500 font-medium">Canterbury, Kent, United Kingdom</p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-6">
            ...
            <div>
              <h4 className="text-xl font-black text-primary uppercase tracking-tight">Main Branch India</h4>
              <p className="text-slate-500 font-medium">Guntur</p>
            </div>
          </div>
        </div>
      </div>
